...
ChatAvatar::ChatAvatar(ChatAvatarService* avatarService, const std::wstring& name, const std::wstring& address, uint32_t userId,
...
void ChatAvatar::UpdateFriendComment(const ChatAvatar* avatar, const std::wstring& comment) {
